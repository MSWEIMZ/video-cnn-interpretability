...
**作者**: Panagiotis Antoniadis, Panagiotis P. Filntisis, Petros Maragos

**发表信息**: arXiv · 2021

**论文链接**: [arXiv:2106.03487v2](http://arxiv.org/abs/2106.03487v2)
...
> Over the past few years, deep learning methods have shown remarkable results in many face-related tasks including automatic facial expression recognition (FER) in-the-wild.
