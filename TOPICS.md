...
> 共 8 个主题 | 最后更新: 2026-09-17 06:01

## 📊 主题概览

| 主题 | 论文数 | 核心论文 | 说明 |
|------|--------|----------|------|
| 时序解释 | 931 | 435 | 聚焦于视频时序维度的可解释性研究 |
| 视频 Transformer 可解释性 | 279 | 124 | Vision Transformer / Video Transformer 的可解释性 |
| 动作识别可解释性 | 270 | 136 | 视频动作识别 / 分类任务的可解释性研究 |
| 网络解剖 | 258 | 112 | 网络内部单元 / 特征可视化与解剖 |
